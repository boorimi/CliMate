...
public interface CommunityMapper {
    ...
    // 자랑게시판 전체조회
    @Select("SELECT bo.*, u_nickname, u_grade, (SELECT COUNT(*) FROM cli_like WHERE l_b_pk = bo.b_pk) AS l_count FROM cli_board bo JOIN cli_user ON u_id = b_u_id WHERE b_category = '動画'")
