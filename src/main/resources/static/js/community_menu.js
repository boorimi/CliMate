$(document).ready(function () {
    ...
    searchOpenIcon.append('<img src="/resources/icon/search.png">');
    ...
    searchOpenIcon.click(function () {
        ...
        // 아이콘 토글
        if (iconImg.attr('src') === '/resources/icon/search.png') {
            iconImg.attr('src', '/resources/icon/close.png');
            iconImg.css('width', '50%');
        } else {
            iconImg.attr('src', '/resources/icon/search.png');
            iconImg.css('width', '100%');
        }
    });
