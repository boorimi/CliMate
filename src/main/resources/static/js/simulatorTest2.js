...
class App {
    constructor() {
        ...
        this._gltfModels = []; // GLTF 모델을 담을 배열 추가

        divContainer.addEventListener('click', this.onClick.bind(this), false);
    }
    ...
    onClick(event) {
        ...
        const intersects = this._raycaster.intersectObjects(this._gltfModels, true);
        ...
        if (intersects.length > 0) {
            ...
            if (object === this._selectedObject) {
                ...
                if (this._selectedObject) {
                    this._selectedObject.material.color.setHex(this._selectedObject.userData.originalColor);
                }
